<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Auction extends CI_Model {
		...
		public function product_detail($product_id) {
			// get the product information for the provided id, and return an array of that information.
		...
		public function validate_bid($bid_info)
		{
			$this->load->helper(array('form', 'url'));
			$this->load->library('form_validation');
			$this->form_validation->set_rules('updated_price', 'Bid', 'trim|numeric|required|greater_than[0]|xss_clean');
